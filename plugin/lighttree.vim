function! s:event_init()
    ...
    call lighttree#events#register('reload_node')
endfunction
...
function! s:config_init()
    ...
    let g:lighttree_win_args = get(g:, 'lighttree_win_args', {'follow': ['nerdtree', 'lighttree', "NvimTree"]})
    ...
    let g:lighttree_java_server_name = get(g:, 'lighttree_java_server_name', 'jdtls')
endfunction
